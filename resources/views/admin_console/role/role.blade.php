...
@section('content')
                ...
                <div class="modal fade" id="update_role_{{ $role->id }}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ url('admin_console/role/'.$role->id) }}" method="POST" class="validate" role="form">
                                @method('PUT')
                                @csrf
    ...
    <div class="modal fade" id="add_role">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('admin_console/role') }}" method="POST" class="validate" role="form" id="form1">
                    @csrf
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
