                ...
                <div class="panel-body">
                    <form action="{{ url('role/add_role') }}" method="POST" role="form" id="form1" class="validate">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Ex: Role Title" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="permissions" id="permissions" class="form-control" cols="30" rows="2" data-validate="maxlength[150]" placeholder="Max 150 Character">{{ old('permissions') }}</textarea>
                        </div>
                        <div class="form-group">
