...
@section('content')
                ...
                <div class="modal fade" id="update_permission_{{ $perm->id }}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('permission.update', ['id'=>$perm->id]) }}" method="POST" class="validate" role="form">
                                @method('PUT')
                                @csrf
    ...
    <div class="modal fade" id="add_permission">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('permission.store') }}" method="POST" class="validate" role="form" id="form1">
                    @csrf
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
